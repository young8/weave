...
func createOverlay(bridgeType weavenet.BridgeType, config weavenet.BridgeConfig, isAWSVPC bool, host string, port int, bufSzMB int) (weave.NetworkOverlay, weave.Bridge) {
